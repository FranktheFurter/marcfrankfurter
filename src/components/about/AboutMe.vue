...
<template>
  <div class="block sm:flex sm:gap-10 mt-10 sm:mt-20">
    ...
    <div class="w-full sm:w-1/4 mb-7 sm:mb-0">
      <img src="@/assets/images/me.png" class="rounded-xl w-96" alt=""/>
    </div>

    <!-- About details -->
    <div class="w-full sm:w-3/4 text-left align-text-bottom">
